    ...
    return (
        <div className="min-h-screen bg-slate-50 text-slate-900 pb-20 relative">
            ...
            <ToolHeader
                ...
                title="元问题"
                titleHighlight="拆解大师"
                subtitle="海量选题归纳与提炼 · 深度洞察"
                rightContent={
                    <button
                        onClick={() => setShowHistory(true)}
                        className="flex items-center space-x-1 text-slate-500 hover:text-indigo-600 transition-colors text-[13px] font-medium px-3 py-1.5 rounded-lg hover:bg-slate-100/50"
                    >
                                                                ...
                                                                {isExpanded && (
                                                                    <div className="px-6 pb-4 pl-10">
                                                                        <div className="bg-slate-50 rounded-lg p-3 border border-slate-100 text-sm text-slate-600">
                                                                            ...
                                                                            <ul className="list-disc list-inside space-y-1 ml-1 max-h-60 overflow-y-auto">
                                                                                {q.originalTopics.map((topic, tIdx) => (
                                                                                    <li key={tIdx} className="text-slate-500 leading-snug break-words pl-1">
                                                                                        {topic}
                                                                                    </li>
                                                                                ))}
                                                                            </ul>
